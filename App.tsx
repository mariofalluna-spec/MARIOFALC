            ...
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
               ...
               <nav className="flex flex-wrap justify-center gap-2 md:gap-3">
                {specialties.map((spec) => (
                  <div 
                    key={spec.name} 
                    className="group/pill flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-white border border-slate-200 text-[10px] md:text-sm font-medium text-slate-600 transition-all duration-300 ease-out cursor-pointer hover:text-white hover:bg-cyan-500 hover:border-transparent hover:shadow-[0_4px_15px_rgba(6,182,212,0.3)]"
                  >
                    <spec.icon size={12} className="text-cyan-500 group-hover:text-white transition-colors md:w-[14px] md:h-[14px]" />
        ...
        <footer className="w-full bg-white py-16 md:py-24 px-6 md:px-16 border-t border-slate-100">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <p className="text-slate-400 text-sm md:text-base mb-1 uppercase tracking-tighter">Lunes a Sábado</p>
              <p className="text-slate-800 font-bold text-2xl tracking-tight">10:00 am - 8:00 pm</p>
